...
Hooks.once("init", async function() {
  ...
  Actors.registerSheet("dimdayred", DwActorSheet, {
    types: ['character'],
    makeDefault: true
  });
  Actors.registerSheet("dimdayred", DwActorNpcSheet, {
    types: ['npc'],
    makeDefault: true
  });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("dimdayred", DwItemSheet, { makeDefault: false });
  Items.registerSheet("dimdayred", DwClassItemSheet, {
    types: ['class'],
    makeDefault: true
  });
   ...
   */
  game.settings.register("dimdayred", "systemMigrationVersion", {
  ...
  game.settings.register("dimdayred", "xpFormula", {
  ...
  game.settings.register("dimdayred", "advForward", {
  ...
  game.settings.register("dimdayred", "disDebility", {
  ...
  game.settings.register("dimdayred", "enableDamageButtons", {
  ...
  game.settings.register("dimdayred", "nightmode", {
  ...
  game.settings.register("dimdayred", "alignmentSingle", {
  ...
  game.settings.register("dimdayred", "alignmentPlural", {
  ...
  game.settings.register("dimdayred", "raceSingle", {
  ...
  game.settings.register("dimdayred", "racePlural", {
  ...
  game.settings.register("dimdayred", "bondSingle", {
  ...
  game.settings.register("dimdayred", "bondPlural", {
  ...
  game.settings.register("dimdayred", "noCompendiumAutoData", {
  ...
  game.settings.register("dimdayred", "compendiumPrefix", {
  ...
  game.settings.register("dimdayred", "noAbilityScores", {
  ...
  game.settings.register("dimdayred", "noAbilityIncrease", {
  ...
  game.settings.register("dimdayred", "noConstitutionToHP", {
  ...
  game.settings.register("dimdayred", "noSTRToMaxLoad", {
  ...
  game.settings.register("dimdayred", "debilityLabelSTR", {
  ...
  game.settings.register("dimdayred", "debilityLabelWIS", {
  ...
  game.settings.register("dimdayred", "debilityLabelCHA", {
